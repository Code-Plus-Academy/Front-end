...
function VideoPlayer({ video, t, isMobile }) {
  ...
  const isNonEmbeddable = ['twitter', 'tiktok'].includes(platform); // instagram is embeddable via /reel/embed
  ...
  const btns = [
    {
      key: 'like',
      icon: (
        <ClapIcon size={45} width={45} height={45} color="currentColor" filled={video.viewer_liked} />
      ),
