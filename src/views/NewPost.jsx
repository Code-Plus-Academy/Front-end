            ...
            {tab === 'social' ? (
              ...
              >
                ...
                <div style={{ display: 'flex', gap: 12, paddingTop: 16, justifyContent: 'flex-end', borderTop: '1px solid #1f242b', marginTop: 12 }}>
                  <button type="button" onClick={() => navigate(-1)} style={{ padding: '12px 24px', borderRadius: 30, background: 'transparent', border: '1px solid #2a3038', color: '#dee3ea', cursor: 'pointer', fontWeight: 600 }}>Cancel</button>
