    ...
    async function fetchPost() {
      try {
        ...
        if (parsedCode) {
          ...
          setCodeLanguage(parsedCode.language || 'auto');
  ...
  if (loading) {
    return (
      <div style={{ minHeight: '60vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, color: 'var(--primary, #00dbe9)', fontFamily: T.fontMono, fontSize: 13 }}>
    ...
    <div style={{
      ...
      <div style={{
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: isMobile ? 12 : 14 }}>
          ...
          {/* Code Snippet Module */}
          <div style={{
            background: includeCode ? 'rgba(0, 219, 233, 0.03)' : 'var(--s2, #070a0e)',
            border: `1px solid ${includeCode ? 'rgba(0, 219, 233, 0.35)' : 'var(--border, rgba(255,255,255,0.08))'}`,
            borderRadius: 10,
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 6, flexWrap: 'wrap' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, minWidth: 0, flex: 1 }}>
                <div style={{
                  ...
                  border: `1px solid ${includeCode ? 'rgba(0, 219, 233, 0.4)' : 'var(--border, rgba(255,255,255,0.08))'}`,
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                  color: includeCode ? 'var(--primary, #00dbe9)' : 'var(--dim, #94a3b8)',
                  flexShrink: 0,
                }}>
                  <Code2 size={15} />
                </div>
                <div style={{ minWidth: 0 }}>
                  <div style={{ fontSize: 12, fontWeight: 700, color: 'var(--text, #f0f2f8)', display: 'flex', alignItems: 'center', gap: 6 }}>
              ...
              <button
                ...
                style={{
                  padding: '4px 10px',
                  borderRadius: 6,
                  background: includeCode ? 'rgba(0, 219, 233, 0.15)' : 'var(--s3, rgba(255, 255, 255, 0.06))',
                  border: `1px solid ${includeCode ? 'var(--primary, #00dbe9)' : 'var(--border, rgba(255,255,255,0.1))'}`,
                  color: includeCode ? 'var(--primary, #00dbe9)' : 'var(--text, #f0f2f8)',
                  fontSize: 11,
                  fontWeight: 700,
                  cursor: 'pointer',
                ...
                >
                  ...
                  <div>
                    <div style={{
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: 5 }}>
                        ...
                        <span>{codeLanguage === 'auto' ? detectLanguage(codeSnippet) + ' (auto)' : codeLanguage}</span>
                      </div>
                  ...
                  {codeSnippet.trim() && (
                    <div style={{ marginTop: 8 }}>
                      <span style={{ ...labelStyle, fontSize: 9, color: 'var(--primary, #00dbe9)' }}>
                        // Live Card Preview
                      </span>
                      <CodeSnippetCard
                        code={codeSnippet}
              ...
              {tags.map((tag, i) => (
                <span key={i} style={{
                  ...
                  <button
                    ...
                    style={{ background: 'none', border: 'none', color: 'var(--primary, #00dbe9)', cursor: 'pointer', padding: 0, display: 'flex' }}
                  >
                    <X size={11} />
                  </button>
                </span>
