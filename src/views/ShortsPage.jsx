...
function SideRail({ video, onLike, onSave, onShare, onComment, onMore, navigate }) {
  ...
  const actions = [
    { key: 'like', icon: (on) => (<ClapIcon size={45} width={45} height={45} color={on ? T.red : 'currentColor'} filled={on} />), label: fmtN(video.likes_count), on: video.viewer_liked, color: T.red, action: onLike },
