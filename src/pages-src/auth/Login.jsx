...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const params = new URLSearchParams(window.searchParams?.toString() ? '?' + searchParams.toString() : '');
    ...
    >
      ...
      <div className="auth-field">
        <div className="auth-label-row">
          ...
          <Link href="/forgot-password" className="auth-bypass">[bypass]</Link>
        </div>
        <div className="auth-input-wrap">
          <span className="auth-prompt">&gt;</span>
          <input
      ...
      <p className="auth-footer-text">
        No node cluster?{' '}
        <Link href="/register">[INIT_REGISTRATION]</Link>
      </p>
    </AuthTerminalLayout>
  );
}
