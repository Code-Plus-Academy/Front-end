...
export default function Feed() {
  ...
  return (
    <>
      <Helmet><title>Feed — Code+ Academy</title></Helmet>
      <NoIndex />
      <style>{`
      ...
      <div className="feed-page" style={{ padding: '16px 16px 90px', maxWidth: 1240, margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
          <div>
            <h1 style={{ margin: 0, color:'var(--text)', fontSize: 20, fontWeight: 800 }}>Creator Feed</h1>
            <p style={{ margin: '4px 0 0', color:'var(--sub)', fontSize: 12 }}>Live posts from the backend</p>
          </div>
          <button
            ...
            style={{
              ...
              color: showFilter ? '#d0bcff' : '#ccc3da',
              borderRadius: 10,
              padding: '8px 12px',
              fontSize: 11,
              fontWeight: 700,
