  ...
  return (
    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', minHeight: 0, overflow: 'hidden' }}>
      ...
      <div style={{ padding: '12px 16px', background: T.surface, borderBottom: `1px solid ${T.cardBorder}`, display: 'flex', alignItems: 'center', gap: 12, flexShrink: 0 }}>
        ...
        {other && (
          <Link href={`/u/${other.username}`} style={{ display: 'flex', alignItems: 'center', gap: 10, flex: 1, textDecoration: 'none' }}>
            <div style={{ position: 'relative' }}>
      ...
      <div className="network-mobile" style={{ background: T.bg, minHeight: '100dvh', paddingBottom: 80, width: '108vw', marginLeft: 'calc(-50vw + 50%)', marginRight: 'calc(-50vw + 50%)' }}>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: 6, alignItems: 'center' }}>
            <button className="icon-btn" onClick={() => nav.push('/notifications')} style={{ width: 34, height: 34, borderRadius: 10, background: T.surface, border: `1px solid ${T.cardBorder}`, color: T.textMuted, position: 'relative' }}>
        ...
        <div style={{ padding: '12px 14px 0' }}>
          ...
          <div style={{ marginTop: 18, marginBottom: 20 }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10 }}>
              ...
              <button onClick={() => nav.push('/explore')} style={{ background: 'none', border: 'none', cursor: 'pointer', fontSize: 12, color: T.accent, fontFamily: FONT.display, fontWeight: 600 }}>View all →</button>
            </div>
      ...
      <div className="network-desktop" style={{ margin: '-16px -32px', gap: 0, minHeight: 'calc(100vh - 64px)', background: T.bg }}>
        ...
        <div style={{ width: 300, flexShrink: 0, borderLeft: `1px solid ${T.cardBorder}`, padding: 24, display: 'flex', flexDirection: 'column', gap: 20 }}>
          ...
          <div style={{ background: T.accentSoft, borderRadius: 14, padding: '14px 16px', border: `1px solid ${T.accentGlow}` }}>
            ...
            <button onClick={() => nav.push('/settings')} style={{ width: '100%', background: T.accent, border: 'none', borderRadius: 9, padding: '8px 0', color: '#fff', fontFamily: FONT.display, fontWeight: 700, fontSize: 12, cursor: 'pointer', boxShadow: `0 4px 14px ${T.accentGlow}` }}>
              Upgrade Now →
            </button>
          </div>
        </div>
      ...
      <PageWrapper style={{ maxWidth: 720 }}>
        ...
        {loading ? (
          ...
          <div className="card" style={{ padding: 56, textAlign: 'center' }}>
            ...
            <Link href="/feed"><button className="btn-primary">Browse Feed</button></Link>
          </div>
        ) : (
    ...
    <>
      ...
      <PageWrapper>
        ...
        <div className="card" style={{ padding: 56, textAlign: 'center' }}>
          ...
          <Link href="/explore"><button className="btn-primary">Browse Creators</button></Link>
        </div>
      </PageWrapper>
    </>
  );
